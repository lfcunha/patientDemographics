...
class patientController extends baseController {
    ...
    public function generatePnumber($data){
        ...
        foreach ($data as $id){
            ...
            $dataForDb=array("arrivalDate"=>date("Y-m-d"), "project"=>"", "clinician" =>$res["doc"], "originalLabel"=>"", "familyID"=>$familyID, "gender"=>"", "dateofbirth"=>null, "relationship"=>$res["relationship"], "phenotype"=>$res["diagnosisReferral"], "cyrilic"=>"", "intExt"=>"", "institute"=>$res["Institution"], "country"=>"", "receiverName"=>"", "alternativeID"=>"", "notes"=>"", "patientId"=>$id);
