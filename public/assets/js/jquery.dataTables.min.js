    ...
    var N = function(h) {
        ...
        function nb(a) {
            var b = a.oClasses,
                ...
                e = a.oPreviousSearch,
                f = a.aanFeatures;
            /* Luis: added advanced search toggle after quick search input field */

            if((document.URL.indexOf("isolates")>0)){
             var   g='<input  type="search" class="' + b.sFilterInput + '"/><span onclick="toggleSearch()" id="advancedSearch"><a href="#" id="advancedSearchA"><i class="fa fa-search" id="faAvancedSearch"></i>&nbsp;Advanced Search</a></span>';
            }
            else{
           var g = '<input  type="search" class="' + b.sFilterInput + '"/>';
            }
            var j = d.sSearch,
        ...
        function Ab(a) {
            ...
            if (0 !== b.length) {
                ...
                h(b).html(j);
                setTableToggle();  //Luis: toggle between the links for full/condensed table versions
        ...
        p.defaults = {
            ...
            oLanguage: {
                ...
                //sSearch: "",
                sSearchPlaceholder: "",
                //sSearchPlaceholder: "quick search",
                //
                sUrl: "",
            ...
            sServerMethod: "GET",
            renderer: null
        }; //Luis. set extra fields for the different tables
        if (document.URL.indexOf("isolates")>0){
            p.defaults.oLanguage.sInfo= 'Showing _START_ to _END_ of _TOTAL_ entries &nbsp;&nbsp;/<span onclick="toggleTable()" id="toggleTable" class="showAll"><a href="#" id="toggleTableA">&nbsp;&nbsp;&nbsp;show all/condensed data fields</a></span>';
            }
